...
<body>
	...
	<ul >
			...
			<div id="main">
				<div id="main2"></div>
				<h2> Mr Ashish Ranjan</h2>
				    <!--img id="image2" src="C:\Users\Parkash Rai\Desktop\r.jpg" align="left"-->

			    <p> My name is Ashish Ranjan and i am currently final year student of Computer Science and Engineering from Gaya COllege of Engineering ,Gaya. I am a web developer with 1.5 years
of self-project experiences.I have also worked on different
programming languages such as,HTML,CSS,JavaScript, PHP ,
MYSQL ,PYTHON ,JAVA and WordPress.I have also experience in Android studio for 3 years.
